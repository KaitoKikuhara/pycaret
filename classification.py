...
def setup(data,
    ...
    numeric_imputation: string, default = 'mean' (数値に欠損値が見つかった場合の補間する値の算出方法を指定　デフォルトが平均, もう一つがmedian)
    ...
    date_features: string, default = None (日付のcolumnを指定　デフォルトはなし、　その場合削除)
